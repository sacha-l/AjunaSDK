...
namespace AjunaExample.RestService.Generated.Storage
{
    ...
    public interface ISudoStorage : IStorage
    {
        ...
        /// </summary>
        AjunaExample.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetKey();
    }
    ...
    public sealed class SudoStorage : ISudoStorage
    {
        ...
        /// </summary>
        private TypedStorage<AjunaExample.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> _keyTypedStorage;
        ...
        {
            this.KeyTypedStorage = new TypedStorage<AjunaExample.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>("Sudo.Key", storageDataProvider, storageChangeDelegates);
        }
        
        /// <summary>
        /// _keyTypedStorage property
        /// </summary>
        public TypedStorage<AjunaExample.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> KeyTypedStorage
        {
            get
            {
        ...
        ///  The `AccountId` of the sudo key.
        /// </summary>
        public AjunaExample.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetKey()
        {
