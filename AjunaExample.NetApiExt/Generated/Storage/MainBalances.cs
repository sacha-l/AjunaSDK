...
namespace AjunaExample.NetApiExt.Generated.Storage
{
    ...
    public sealed class BalancesStorage
    {
        ...
        public BalancesStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Balances", "Account"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(AjunaExample.NetApiExt.Generated.Model.sp_core.crypto.AccountId32), typeof(AjunaExample.NetApiExt.Generated.Model.pallet_balances.AccountData)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Balances", "Locks"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(AjunaExample.NetApiExt.Generated.Model.sp_core.crypto.AccountId32), typeof(AjunaExample.NetApiExt.Generated.Model.sp_runtime.bounded.weak_bounded_vec.WeakBoundedVecT2)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Balances", "Reserves"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(AjunaExample.NetApiExt.Generated.Model.sp_core.crypto.AccountId32), typeof(AjunaExample.NetApiExt.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT3)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Balances", "StorageVersion"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(AjunaExample.NetApiExt.Generated.Model.pallet_balances.EnumReleases)));
        }
        ...
        ///  NOTE: This is only used in the case that this pallet is used to store balances.
        /// </summary>
        public async Task<AjunaExample.NetApiExt.Generated.Model.pallet_balances.AccountData> Account(AjunaExample.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
            string parameters = BalancesStorage.AccountParams(key);
            return await _client.GetStorageAsync<AjunaExample.NetApiExt.Generated.Model.pallet_balances.AccountData>(parameters, token);
        }
        ...
        ///  NOTE: Should only be accessed when setting, changing and freeing a lock.
        /// </summary>
        public async Task<AjunaExample.NetApiExt.Generated.Model.sp_runtime.bounded.weak_bounded_vec.WeakBoundedVecT2> Locks(AjunaExample.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
            string parameters = BalancesStorage.LocksParams(key);
            return await _client.GetStorageAsync<AjunaExample.NetApiExt.Generated.Model.sp_runtime.bounded.weak_bounded_vec.WeakBoundedVecT2>(parameters, token);
        }
        ...
        ///  Named reserves on some account balances.
        /// </summary>
        public async Task<AjunaExample.NetApiExt.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT3> Reserves(AjunaExample.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
            string parameters = BalancesStorage.ReservesParams(key);
            return await _client.GetStorageAsync<AjunaExample.NetApiExt.Generated.Model.sp_runtime.bounded.bounded_vec.BoundedVecT3>(parameters, token);
        }
        ...
        public async Task<AjunaExample.NetApiExt.Generated.Model.pallet_balances.EnumReleases> StorageVersion(CancellationToken token)
        {
            ...
            return await _client.GetStorageAsync<AjunaExample.NetApiExt.Generated.Model.pallet_balances.EnumReleases>(parameters, token);
        }
    }
    ...
    public sealed class BalancesCalls
    {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method SetBalance(AjunaExample.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress who, Ajuna.NetApi.Model.Types.Base.BaseCom<Ajuna.NetApi.Model.Types.Primitive.U128> new_free, Ajuna.NetApi.Model.Types.Base.BaseCom<Ajuna.NetApi.Model.Types.Primitive.U128> new_reserved)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
