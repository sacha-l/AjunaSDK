...
namespace AjunaExample.NetApiExt.Generated.Storage
{
    ...
    public sealed class GrandpaStorage
    {
        ...
        public async Task<AjunaExample.NetApiExt.Generated.Model.pallet_grandpa.EnumStoredState> State(CancellationToken token)
        {
            ...
            return await _client.GetStorageAsync<AjunaExample.NetApiExt.Generated.Model.pallet_grandpa.EnumStoredState>(parameters, token);
        }
        ...
        public async Task<AjunaExample.NetApiExt.Generated.Model.pallet_grandpa.StoredPendingChange> PendingChange(CancellationToken token)
        {
            ...
            return await _client.GetStorageAsync<AjunaExample.NetApiExt.Generated.Model.pallet_grandpa.StoredPendingChange>(parameters, token);
        }
    ...
    public sealed class GrandpaCalls
    {
        ...
        /// </summary>
        public static Method ReportEquivocation(AjunaExample.NetApiExt.Generated.Model.sp_finality_grandpa.EquivocationProof equivocation_proof, Ajuna.NetApi.Model.Types.Base.BaseVoid key_owner_proof)
        {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method ReportEquivocationUnsigned(AjunaExample.NetApiExt.Generated.Model.sp_finality_grandpa.EquivocationProof equivocation_proof, Ajuna.NetApi.Model.Types.Base.BaseVoid key_owner_proof)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(equivocation_proof.Encode());
            byteArray.AddRange(key_owner_proof.Encode());
