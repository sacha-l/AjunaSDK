...
namespace AjunaExample.RestClient.Generated.Clients
{
   ...
   public sealed class GrandpaControllerClient : BaseClient, IGrandpaControllerClient
   {
      ...
      {
         return await SendRequestAsync<U32>(_httpClient, "grandpa/setidsession", AjunaExample.NetApiExt.Generated.Storage.GrandpaStorage.SetIdSessionParams(key));
      }
      public async Task<bool> SubscribeSetIdSession(U64 key)
      {
         return await _subscriptionClient.SubscribeAsync("Grandpa.SetIdSession", AjunaExample.NetApiExt.Generated.Storage.GrandpaStorage.SetIdSessionParams(key));
      }
   }
}
