...
namespace AjunaExample.RestClient.Generated.Clients
{
   ...
   public sealed class SystemControllerClient : BaseClient, ISystemControllerClient
   {
      ...
      public async Task<AccountInfo> GetAccount(AjunaExample.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await SendRequestAsync<AccountInfo>(_httpClient, "system/account", AjunaExample.NetApiExt.Generated.Storage.SystemStorage.AccountParams(key));
      }
      public async Task<bool> SubscribeAccount(AjunaExample.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
      {
         return await _subscriptionClient.SubscribeAsync("System.Account", AjunaExample.NetApiExt.Generated.Storage.SystemStorage.AccountParams(key));
      }
      ...
      {
         return await SendRequestAsync<H256>(_httpClient, "system/blockhash", AjunaExample.NetApiExt.Generated.Storage.SystemStorage.BlockHashParams(key));
      }
      public async Task<bool> SubscribeBlockHash(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("System.BlockHash", AjunaExample.NetApiExt.Generated.Storage.SystemStorage.BlockHashParams(key));
      }
      public async Task<BaseVec<U8>> GetExtrinsicData(U32 key)
      {
         return await SendRequestAsync<BaseVec<U8>>(_httpClient, "system/extrinsicdata", AjunaExample.NetApiExt.Generated.Storage.SystemStorage.ExtrinsicDataParams(key));
      }
      public async Task<bool> SubscribeExtrinsicData(U32 key)
      {
         return await _subscriptionClient.SubscribeAsync("System.ExtrinsicData", AjunaExample.NetApiExt.Generated.Storage.SystemStorage.ExtrinsicDataParams(key));
      }
      ...
      {
         return await SendRequestAsync<BaseVec<BaseTuple<U32, U32>>>(_httpClient, "system/eventtopics", AjunaExample.NetApiExt.Generated.Storage.SystemStorage.EventTopicsParams(key));
      }
      public async Task<bool> SubscribeEventTopics(H256 key)
      {
         return await _subscriptionClient.SubscribeAsync("System.EventTopics", AjunaExample.NetApiExt.Generated.Storage.SystemStorage.EventTopicsParams(key));
      }
