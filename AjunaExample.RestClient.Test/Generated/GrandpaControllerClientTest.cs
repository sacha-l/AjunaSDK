...
namespace AjunaExample.RestClient.Test.Generated
{
   ...
   public class GrandpaControllerClientTest : ClientTestBase
   {
      ...
      public AjunaExample.NetApiExt.Generated.Model.pallet_grandpa.EnumStoredState GetTestValue2()
      {
         AjunaExample.NetApiExt.Generated.Model.pallet_grandpa.EnumStoredState result;
         result = new AjunaExample.NetApiExt.Generated.Model.pallet_grandpa.EnumStoredState();
         result.Create(this.GetTestValueEnum<AjunaExample.NetApiExt.Generated.Model.pallet_grandpa.StoredState>(), this.GetTestValueBaseVoid());
         return result;
      }
      [Test()]
      public async System.Threading.Tasks.Task TestState()
      {
         ...
         AjunaExample.NetApiExt.Generated.Model.pallet_grandpa.EnumStoredState mockupValue = this.GetTestValue2();
         ...
         AjunaExample.NetApiExt.Generated.Model.pallet_grandpa.EnumStoredState rpcResult = await rpcClient.GetState();

         // Test that the expected mockup value matches the actual result from RPC service.
         Assert.AreEqual(mockupValue.Encode(), rpcResult.Encode());
      }
      public AjunaExample.NetApiExt.Generated.Model.pallet_grandpa.StoredPendingChange GetTestValue4()
      {
         AjunaExample.NetApiExt.Generated.Model.pallet_grandpa.StoredPendingChange result;
         result = new AjunaExample.NetApiExt.Generated.Model.pallet_grandpa.StoredPendingChange();
         result.ScheduledAt = this.GetTestValueU32();
         result.Delay = this.GetTestValueU32();
         result.NextAuthorities = new AjunaExample.NetApiExt.Generated.Model.sp_runtime.bounded.weak_bounded_vec.WeakBoundedVecT1();
      ...
      public AjunaExample.NetApiExt.Generated.Model.sp_runtime.bounded.weak_bounded_vec.WeakBoundedVecT1 GetTestValue5()
      {
         AjunaExample.NetApiExt.Generated.Model.sp_runtime.bounded.weak_bounded_vec.WeakBoundedVecT1 result;
         result = new AjunaExample.NetApiExt.Generated.Model.sp_runtime.bounded.weak_bounded_vec.WeakBoundedVecT1();
         result.Value = new Ajuna.NetApi.Model.Types.Base.BaseVec<Ajuna.NetApi.Model.Types.Base.BaseTuple<AjunaExample.NetApiExt.Generated.Model.sp_finality_grandpa.app.Public, Ajuna.NetApi.Model.Types.Primitive.U64>>();
         result.Value.Create(new Ajuna.NetApi.Model.Types.Base.BaseTuple<AjunaExample.NetApiExt.Generated.Model.sp_finality_grandpa.app.Public, Ajuna.NetApi.Model.Types.Primitive.U64>[] {
                  this.GetTestValue6()});
         return result;
      }
      public Ajuna.NetApi.Model.Types.Base.BaseTuple<AjunaExample.NetApiExt.Generated.Model.sp_finality_grandpa.app.Public, Ajuna.NetApi.Model.Types.Primitive.U64> GetTestValue6()
      {
         Ajuna.NetApi.Model.Types.Base.BaseTuple<AjunaExample.NetApiExt.Generated.Model.sp_finality_grandpa.app.Public, Ajuna.NetApi.Model.Types.Primitive.U64> result;
         result = new Ajuna.NetApi.Model.Types.Base.BaseTuple<AjunaExample.NetApiExt.Generated.Model.sp_finality_grandpa.app.Public, Ajuna.NetApi.Model.Types.Primitive.U64>();
         result.Create(this.GetTestValue7(), this.GetTestValueU64());
         return result;
      }
      public AjunaExample.NetApiExt.Generated.Model.sp_finality_grandpa.app.Public GetTestValue7()
      {
         AjunaExample.NetApiExt.Generated.Model.sp_finality_grandpa.app.Public result;
         result = new AjunaExample.NetApiExt.Generated.Model.sp_finality_grandpa.app.Public();
         result.Value = new AjunaExample.NetApiExt.Generated.Model.sp_core.ed25519.Public();
         result.Value = this.GetTestValue8();
         return result;
      }
      public AjunaExample.NetApiExt.Generated.Model.sp_core.ed25519.Public GetTestValue8()
      {
         AjunaExample.NetApiExt.Generated.Model.sp_core.ed25519.Public result;
         result = new AjunaExample.NetApiExt.Generated.Model.sp_core.ed25519.Public();
      ...
      public async System.Threading.Tasks.Task TestPendingChange()
      {
         ...
         // Construct new RPC client to test with.
         GrandpaControllerClient rpcClient = new GrandpaControllerClient(_httpClient, subscriptionClient);
         AjunaExample.NetApiExt.Generated.Model.pallet_grandpa.StoredPendingChange mockupValue = this.GetTestValue4();
         ...
         AjunaExample.NetApiExt.Generated.Model.pallet_grandpa.StoredPendingChange rpcResult = await rpcClient.GetPendingChange();
